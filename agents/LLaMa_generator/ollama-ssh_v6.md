Ниже приведён пример обновленного файла README.md, оформленного с оглавлением, разделами и понятным описанием работы скрипта, включая пример использования с диаграммой:
